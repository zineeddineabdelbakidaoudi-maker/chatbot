...
export async function analyzeImage(base64Data, mimeType) {
  try {
    const messages = [
      {
        role: "user",
        content: [
          { type: "text", text: "You are a Hunter x Hunter expert. Analyze this image. If the image shows a Hunter x Hunter character, identify them.\nIf the image does NOT show a Hunter x Hunter character, you MUST set in_domain to \"no\".\nDo not describe or identify characters from other anime like Death Note or Naruto.\n\nRespond strictly in JSON format:\n{\n  \"character\": \"name or unknown\",\n  \"in_domain\": \"yes\" or \"no\",\n  \"confidence\": \"high\", \"medium\", \"low\", or \"none\"\n}" },
    ...
    return { character: null, in_domain: "no", confidence: "none" };
  } catch (error) {
