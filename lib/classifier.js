...
const TEAM_KEYWORDS = [
  ...
  "project team", "who developed",
  "university", "student", "students", "academic", "field of study",
  // Team member names
  "daoudi", "zineddine", "abdelbaki", "akhrouf", "abderraouf", 
  "mebarkia", "hamza", "aymane", "bouziane", "fadel", "errahmane", 
  "yassine", "mili"
];

const GREETING_KEYWORDS = [
  "hi", "hello", "hey", "how are you", "who are you", "what are you", "good morning", "good evening", "greetings"
];
...
export async function classifyMessage(message) {
  ...
  for (const kw of GREETING_KEYWORDS) {
    ...
    if (regex.test(normalized)) {
      return { category: "greeting", method: "keyword", confidence: "high" };
    }
  }
